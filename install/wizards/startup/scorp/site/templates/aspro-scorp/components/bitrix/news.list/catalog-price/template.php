									...
									<div class="row">
										...
										<?if($bOrderButton):?>
											<div class="col-md-2 col-sm-3 col-xs-6">
												<span class="btn btn-default btn-sm pull-right" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]['startup_scorp_form']['startup_scorp_order_product'][0]?>" data-product="<?=$arItem['NAME']?>" data-name="order_product"><?=(strlen($arParams['S_ORDER_PRODUCT']) ? $arParams['S_ORDER_PRODUCT'] : GetMessage('S_ORDER_PRODUCT'))?></span>
											</div>
										<?// element buy block?>
										<?elseif($bBuyButton):?>
