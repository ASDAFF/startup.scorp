	...
	<div class="order-block">
		<div class="row">
			<div class="valign <?=($bPrice ? 'col-md-6' : 'col-md-4 col-sm-4 col-xs-5')?>">
				...
				<?endif;?>
				<span class="btn btn-default btn-lg" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]['startup_scorp_form']['startup_scorp_order_study'][0]?>" data-name="order_study" data-autoload-study="<?=$arResult['NAME']?>"><span><?=(strlen($arParams['S_ORDER_STUDY']) ? $arParams['S_ORDER_STUDY'] : GetMessage('S_ORDER_STUDY'))?></span></span>
			</div>
