	...
	<div class="order-block">
		<div class="row">
			<div class="col-md-4 col-sm-4 col-xs-5 valign">
				<span class="btn btn-default btn-lg" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]['startup_scorp_form']['startup_scorp_order_project'][0]?>" data-name="order_project" data-autoload-project="<?=$arResult['NAME']?>"><?=(strlen($arParams['S_ORDER_PROJECT']) ? $arParams['S_ORDER_PROJECT'] : GetMessage('S_ORDER_PROJECT'))?></span>
			</div>
