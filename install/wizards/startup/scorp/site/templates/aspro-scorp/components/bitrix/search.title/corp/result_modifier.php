...
?>
<style type="text/css">
.bx_searche .bx_image{width: <?=$PREVIEW_WIDTH?>px;	height: <?=$PREVIEW_HEIGHT?>px;}
.bx_searche .bx_img_element{width: <?=$PREVIEW_WIDTH + 20?>px;	height: <?=$PREVIEW_HEIGHT +11?>px;}
.bx_searche .bx_item_block{min-height: <?=($minH = ($PREVIEW_HEIGHT + 11 > 35 ? $PREVIEW_HEIGHT + 10 : 35))?>px;line-height: <?=$minH?>px;
</style>
<?
