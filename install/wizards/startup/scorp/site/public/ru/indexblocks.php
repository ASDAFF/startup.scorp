	...
	<div class="greyline">
		<?$APPLICATION->IncludeComponent(
			...
			array(
				...
				"IBLOCK_ID" => CCache::$arIBlocks[SITE_ID]["startup_scorp_content"]["startup_scorp_advtbig"][0],
				"NEWS_COUNT" => "30",
				"SORT_BY1" => "SORT",
				"SORT_ORDER1" => "ASC",
				"SORT_BY2" => "ID",
		...
		<?$APPLICATION->IncludeComponent(
			...
			array(
				"IBLOCK_TYPE" => "startup_scorp_content",
				"IBLOCK_ID" => CCache::$arIBlocks[SITE_ID]["startup_scorp_content"]["startup_scorp_advtsmall"][0],
				"NEWS_COUNT" => "4",
				"SORT_BY1" => "SORT",
				"SORT_ORDER1" => "ASC",
				"SORT_BY2" => "ID",
				...
				<div class="col-md-12">
					<?if($sTeasersIndexTemplate == "front-teasers-pictures"):?>
						<?$APPLICATION->IncludeComponent(
							...
							array(
								"IBLOCK_TYPE" => "startup_scorp_content",
								"IBLOCK_ID" => CCache::$arIBlocks[SITE_ID]["startup_scorp_content"]["startup_scorp_teasers"][0],
								"NEWS_COUNT" => "6",
								"SORT_BY1" => "SORT",
								"SORT_ORDER1" => "ASC",
								"SORT_BY2" => "ID",
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6">
						<?$APPLICATION->IncludeComponent(
							...
							array(
								"IBLOCK_TYPE" => "startup_scorp_content",
								"IBLOCK_ID" => CCache::$arIBlocks[SITE_ID]["startup_scorp_content"]["startup_scorp_news"][0],
								"NEWS_COUNT" => "2",
		...
		<div class="maxwidth-theme">
			<div class="col-md-12">
				<?$APPLICATION->IncludeComponent(
					...
					array(
						"IBLOCK_TYPE" => "startup_scorp_content",
						"IBLOCK_ID" => CCache::$arIBlocks[SITE_ID]["startup_scorp_content"]["startup_scorp_partners"][0],
						"NEWS_COUNT" => "20",
						"SORT_BY1" => "SORT",
						"SORT_ORDER1" => "ASC",
						"SORT_BY2" => "ID",
