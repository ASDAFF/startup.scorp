...
<?include_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/wizards/startup/scorp/css/styles.css");?>
<script>
	<?require_once($_SERVER['DOCUMENT_ROOT']."/bitrix/wizards/startup/scorp/js/jquery-1.8.3.min.js");?>
	<?require_once($_SERVER['DOCUMENT_ROOT']."/bitrix/wizards/startup/scorp/js/jquery.keyboard.js");?>
...
class FinishStep extends CFinishWizardStep{
	...
	function ShowStep(){
		...
		COption::SetOptionString("startup.scorp", "WIZARD_DEMO_INSTALLED", "Y");
	}
}
?>