<?
$MESS['SCORP_OPTIONS_TITLE'] = 'StartUp: Корпоративный сайт современной компании';
$MESS['SCORP_OPTIONS_TITLE_MAIN'] = 'StartUp: Корпоративный сайт современной компании - Настройки';
$MESS['SCORP_NO_RIGHTS_FOR_VIEWING'] = 'Доступ закрыт';
$MESS['SCORP_MODULE_NOT_INCLUDED'] = 'Не удалось подключить модуль StartUp: Корпоративный сайт современной компании';
