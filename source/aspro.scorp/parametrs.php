...
$moduleClass::$arParametrsList = array(
		...
		'OPTIONS' => array(
			...
			'BASE_COLOR' => array(
				...
				'LIST' => array(
					...
					'1' => array('COLOR' => '#e65100', 'TITLE' => GetMessage('BASE_COLOR_1')),
					'2' => array('COLOR' => '#c21f13', 'TITLE' => GetMessage('BASE_COLOR_2')),
					'3' => array('COLOR' => '#b41818', 'TITLE' => GetMessage('BASE_COLOR_3')),
					'4' => array('COLOR' => '#bd1c3c', 'TITLE' => GetMessage('BASE_COLOR_4')),
					...
					'11' => array('COLOR' => '#0d897f', 'TITLE' => GetMessage('BASE_COLOR_11')),
					'12' => array('COLOR' => '#1b9e77', 'TITLE' => GetMessage('BASE_COLOR_12')),
					'13' => array('COLOR' => '#188b30', 'TITLE' => GetMessage('BASE_COLOR_13')),
					'14' => array('COLOR' => '#48a216', 'TITLE' => GetMessage('BASE_COLOR_14')),
				),
				'DEFAULT' => '1',
				'THEME' => 'Y',
			),
			...
			'ADD_SITE_NAME_IN_TITLE' => array(
				'TITLE' => GetMessage('ADD_SITE_NAME_IN_TITLE'),
				'TYPE' => 'checkbox',
				'DEFAULT' => 'Y',
				'THEME' => 'N',
			),
	...
	'ORDER' => array(
		...
		'OPTIONS' => array(
			'ORDER_VIEW' => array(
				'TITLE' => GetMessage('M_ORDER_VIEW'),
				'TYPE' => 'checkbox',
				/*'LIST' => array(
					'DEFAULT' => GetMessage('M_ORDER_VIEW_DEFAULT'),
					'BASKET' => GetMessage('M_ORDER_VIEW_BASKET'),
				),*/
				'DEFAULT' => 'N',
				'THEME' => 'Y',
			),
			'ORDER_BASKET_VIEW' => array(
				'TITLE' => GetMessage('M_ORDER_BASKET_VIEW'),
				'TYPE' => 'selectbox',
				'LIST' => array(
					'HEADER' => GetMessage('M_ORDER_BASKET_VIEW_HEADER'),
					'FLY' => GetMessage('M_ORDER_BASKET_VIEW_FLY'),
				),
				'DEFAULT' => 'HEADER',
				'THEME' => 'Y',
			),
			'URL_BASKET_SECTION' => array(
				'TITLE' => GetMessage('M_URL_BASKET_SECTION'),
				'TYPE' => 'text',
				'DEFAULT' => '#SITE_DIR#cart/',
				'THEME' => 'N',
			),
			'URL_ORDER_SECTION' => array(
				'TITLE' => GetMessage('M_URL_ORDER_SECTION'),
				'TYPE' => 'text',
