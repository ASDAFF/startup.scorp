						...
						if(array_key_exists($optionCode, $arTab["OPTIONS"])){
							...
							if(isset($arOption["NOTE"])){
								if($optionCode == 'GOALS_NOTE'){
									$FORMS_GOALS_LIST = '';
									if(CCache::$arIBlocks[$optionsSiteID]['aspro_scorp_form'] && is_array(CCache::$arIBlocks[$optionsSiteID]['aspro_scorp_form'])){
										foreach(CCache::$arIBlocks[$optionsSiteID]['aspro_scorp_form'] as $arIDs){
