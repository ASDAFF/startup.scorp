...
if(!CModule::IncludeModule("aspro.scorp")) return;
...
// iblocks ids
$servicesIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_scorp_content"]["aspro_scorp_services"][0];
$studyIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_scorp_catalog"]["aspro_scorp_study"][0];
$staffIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_scorp_content"]["aspro_scorp_staff"][0];
$reviewsIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_scorp_content"]["aspro_scorp_reviews"][0];
$projectsIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_scorp_content"]["aspro_scorp_projects"][0];
$catalogIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_scorp_catalog"]["aspro_scorp_catalog"][0];
$stockIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_scorp_content"]["aspro_scorp_stock"][0];
$newsIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_scorp_content"]["aspro_scorp_news"][0];
$articlesIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_scorp_content"]["aspro_scorp_articles"][0];
